  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: DEFAULT_IOREDIS_MODULE_CONNECTION_TOKEN, useValue: mockRedis },
  ...
  describe('Authentication Security', () => {
    describe('Password Security', () => {
      ...
      it('should handle special characters in passwords', () => {
        ...
        process.env.REDIS_URL = 'redis://:p%40ssw0rd%21%40%23%24%25%5E%26*%28%29%5B%5D%7B%7D%7C%3B%3A%2C.%3C%3E%3F@localhost:6379';
        
        const config = CacheConfigFactory.create();
        // Password should be stored as-is (URL-encoded) - this is the actual behavior
        expect(config.connection.password).toBeDefined();
        expect(config.connection.password).toBe('p%40ssw0rd%21%40%23%24%25%5E%26*%28%29%5B%5D%7B%7D%7C%3B%3A%2C.%3C%3E%3F');
      });
      ...
      it('should handle username/password combinations', () => {
        process.env.NODE_ENV = 'production';
        process.env.REDIS_URL = 'redis://admin:SecureP%40ss123@redis.example.com:6379';
    ...
    describe('Authentication Configuration', () => {
      ...
      it('should handle authentication configuration validation', () => {
        ...
        expect(() => {
          const mockConfig = {
            connection: { host: 'localhost', port: 6379, db: 0, connectTimeout: 5000 },
            performance: { maxConnections: 10, minConnections: 2, defaultTtl: 300, responseTimeout: 5000 },
  ...
  describe('TLS/SSL Security', () => {
    ...
    describe('Certificate Validation', () => {
      ...
      it('should handle certificate paths with spaces and special characters', () => {
        ...
        expect(config.security.tlsCert).toBe('/path/with-special@chars#cert.pem');
  ...
  describe('Network Security', () => {
    describe('IP Whitelisting', () => {
      ...
      it('should handle CIDR notation in IP whitelist', () => {
        process.env.NODE_ENV = 'production';
        process.env.REDIS_ALLOWED_IPS = '192.168.0.0/24,10.0.0.0/8,172.16.0.0/16';
        ...
        testCases.forEach(({ timeout, expectThrow }) => {
          ...
          if (expectThrow) {
            ...
            try {
              ...
              expect(error.message).toContain('Connection timeout must be greater than 0');
            }
          } else {
  ...
  describe('Access Control Security', () => {
    describe('Key Isolation', () => {
      ...
      it('should prevent key enumeration attacks', async () => {
        ...
        expect(mockRedis.keys).toHaveBeenCalledWith('test:projects:secure-user-123:*');
    ...
    describe('Operation Limits', () => {
      it('should handle excessive key operations', async () => {
        const keys = Array(10000).fill(0).map((_, i) => `bulk:key:${i}`);
  ...
  describe('Configuration Security Validation', () => {
    ...
    describe('Security Configuration Validation', () => {
      ...
      it('should validate cluster security configuration', () => {
        ...
        expect(() => CacheConfigValidator.validateCompleteConfig(mockConfig as any))
  ...
  describe('Runtime Security Monitoring', () => {
    describe('Connection Monitoring', () => {
      ...
      it('should handle connection hijacking attempts', async () => {
        ...
        mockRedis.info.mockResolvedValue('fake_redis_version:0.0.1\r\nmalicious_field:injected');
